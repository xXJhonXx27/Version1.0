...
<head>
  ...
  <body background="">
    <header>
    <div class="container">
      <h1>Bogota Y Sus Centros Turisticos</h1>
    </div>
  </header>
  <?php 
  $servidor="localhost";
  ...
  $queryD="SELECT * FROM horario_ubc_turismo";
  ...
  while ($registroT=mysqli_fetch_row($resultadoC)){
    ...
    echo $registroT [2]."</td></tr><tr style='color:#01DF01;font-size:17px'><td>";
    echo $registroT [3]."</td></td> </table></center>";
  $contadorR++;
  }
  ?>
<div class="container">
<a style="color: #01DF01; font-size: 35px"  href="Centros_Turisticos_Consulta.html"> Click Aqui Para Realizar Otra Consulta </a>
</div>
<footer>
  <div class="container">
   <h3>Bogota 2018</h3>
