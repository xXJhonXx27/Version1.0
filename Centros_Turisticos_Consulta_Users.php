...
<head>
  ...
  while ($registroT=mysqli_fetch_row($resultadoC)){
    ...
    echo $registroT [3]."</td></tr><tr style='color:#01DF01;font-size:17px'><td>";
    echo $registroT [4]."</td></tr><tr style='color:#01DF01;font-size:17px'><td>";
    echo $registroT [5]."</td></td> </table></center>";
    echo "<br>";
  $contadorR++;
  }
  ?>
